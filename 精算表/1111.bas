...
Private Const COLS_TO_KEEP_FORMULA As String = "P,Q,R,Y,Z,AG,AK,AP,AQ,AR,AS,BA"
'Private Const COLS_TO_KEEP_FORMULA As String = ""
...
Public Sub 原料展開_数式を値に_改修版_Simple()
    ...
    '【1】シートと最終行を設定
    Set wsDst = ThisWorkbook.Sheets("原料展開")
    最終行 = 6000
